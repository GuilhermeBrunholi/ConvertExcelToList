...
namespace TesteExcel
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //ClearColumnsEmpty(columnsEmpty, IndexsList, itemsList);
            Console.WriteLine(JsonConvert.SerializeObject(treatedList));
        }

        static List<List<string>> ReadTable(DataSet arq)
        {
        ...
        static void TreatFile(List<List<string>> list)
        {
        ...
        static void NameColumns(List<List<string>> list)
        {
            var items = list[0];
        ...
        static List<IDictionary<string, string>> CreatNameList(List<List<string>> list)
        {
            var indexs = list[0];
        ...
        static List<IDictionary<string, string>> NameIndexes(List<string> indexes, List<List<string>> listValues)
        {
